...
#     list_display = ['order_id', 'customer', 'total', 'payment_status', 'order_status']
#     list_editable = ['payment_status', 'order_status', 'payment_method']
#     search_fields = ['order_id', 'customer__username']
#     list_filter = ['payment_status', 'order_status']

class OrderAdmin(admin.ModelAdmin):
    list_display = ['order_id', 'customer', 'total', 'payment_status', 'order_status', 'payment_method']  # Added 'payment_method' here
    list_editable = ['payment_status', 'order_status', 'payment_method']
    search_fields = ['order_id', 'customer__username']
    list_filter = ['payment_status', 'order_status']
